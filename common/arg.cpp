...
common_params_context common_params_parser_init(common_params & params,
    ...
    add_opt(common_arg({ "--use-ondemand" },
                       "use on-demand loading for model weights (experimental, Linux only). "
                       "Loads model pages from disk as needed, reducing memory pressure for large models",
                       [](common_params & params) { params.use_ondemand = true; })
                .set_env("LLAMA_ARG_USE_ONDEMAND"));
